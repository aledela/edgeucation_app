...
class CollegesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create college" do
    assert_difference('College.count') do
      post colleges_url, params: { college: { coll_name: @college.coll_name, cost_att: @college.cost_att, zip_code: @college.zip_code } }
    end
  ...
  test "should update college" do
    patch college_url(@college), params: { college: { coll_name: @college.coll_name, cost_att: @college.cost_att, zip_code: @college.zip_code } }
